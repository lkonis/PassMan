...
from AccountManager import AccountMan
...
class PassManager(QWidget):
    ...
    def CreateGrayPallete(self):
        return self.CreatePallete(Qt.lightGray)

    def CreatePallete(self, Qtcolor):
        pg_pallete = QPalette()
        pg_pallete.setColor(QPalette.Window, Qtcolor)
        return pg_pallete

    def CreatePage(self):
        page = QWidget()
        pg_palette = self.CreatePallete(Qt.darkCyan)
